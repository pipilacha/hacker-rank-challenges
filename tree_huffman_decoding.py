...
assert 'ABACA' == execute('ABACA')
assert 'Rumpelstiltskin' == execute('Rumpelstiltskin')
assert '    howmuchwoodwouldawoodchuckchuckifawoodchuckcouldchuckwood?' == execute('    howmuchwoodwouldawoodchuckchuckifawoodchuckcouldchuckwood?')
